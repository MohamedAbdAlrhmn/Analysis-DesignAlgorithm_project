...
namespace Astar
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            if (choice1 == 1) //Run Sample testcase from files
            {
                ...
                int c1 = Convert.ToInt32(Console.ReadLine()); // to choice 
                Console.WriteLine("#################################################################");
                ...
                foreach (var file in sample)
                {
                    ...
                    int N = 0;
                    int j = 0;
                    int[] ress = new int[25]; // size of matrix 
                    bool ok = true;
            ...
            {
                Console.WriteLine("Enter Your Choice :-");
                Console.WriteLine("[1] Vary large Test");

                Console.WriteLine("[2] Manhattan & Hamming");
                Console.WriteLine("[3] Manhattan Only");
